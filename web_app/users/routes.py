...
from web_app.users.forms import RegistrationForm, LoginForm, ResetPasswordForm, UpdateAccountForm, RequestResetForm
...
def register():
    ...
    if form.validate_on_submit():
        ...
        user = User(username=form.username.data, email=form.email.data,
                    password=hashed_password, admin=True, user=False)
        db.session.add(user)
        db.session.commit()
...
@users.route("/user/<int:user_id>/delete", methods=['POST', 'GET'])
@login_required
